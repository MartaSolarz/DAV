...
from lab2.scripts.helper import COUNTRY_NAMES_A, million_formatter, AREA_A

DATA = '../../data/a_cleaned.csv'
OUTPUT = '../../plots/a/bubble.gif'
Y_TEXT = 1025
Y_COUNTRY_CODE = 30
...
def update_legend(ax, scatters):
    ...
    for country, scatter in scatters.items():
        ...
        labels.append(COUNTRY_NAMES_A.get(country, country))
...
def update(frame, years, countries, df, year_text, scatters, ax, country_texts):
    ...
    for country in countries:
        ...
        density = population * 1000000 / AREA_A[country]
...
def main():
    ...
    scatters = {country: ax.scatter([], [], s=[], label=COUNTRY_NAMES_A.get(country, country)) for country in countries}
