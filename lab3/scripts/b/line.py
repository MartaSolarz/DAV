...
from lab2.scripts.helper import COUNTRY_NAMES_B, million_formatter

DATA = '../../data/b_cleaned.csv'
OUTPUT = '../../plots/b/lines.gif'
Y_TEXT = 45
...
def main():
    ...
    country_texts = {country: ax.text(1960, df[country].iloc[0], country, fontsize=12, ha='center') for country in countries}
    ...
    ax.legend([COUNTRY_NAMES_B.get(country, country) for country in countries], fontsize='large', loc='upper left')
