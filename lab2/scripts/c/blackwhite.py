...
from lab2.scripts.helper import million_formatter, HATCH_PATTERNS, COUNTRY_NAMES_C

DATA = '../../data/c_cleaned.csv'
OUTPUT = '../../plots/c/black&white.gif'
Y_LIM = 70
Y_YEAR_TEXT = 65
Y_COUNTRY_CODE = 1
...
def update(year, ax, df):
    ...
    full_country_names = [COUNTRY_NAMES_C.get(country, country) for country in countries]
