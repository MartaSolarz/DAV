...
from lab2.scripts.helper import COUNTRY_NAMES_B, AREA_B, million_formatter

DATA = '../../data/b_cleaned.csv'
OUTPUT = '../../plots/b/bubble.gif'
Y_COUNTRY_CODE = 1
Y_TEXT = 45
...
def update_legend(ax, scatters):
    ...
    for country, scatter in scatters.items():
        ...
        labels.append(COUNTRY_NAMES_B.get(country, country))
...
def update(frame, years, countries, df, year_text, scatters, ax, country_texts):
    ...
    for country in countries:
        ...
        density = population * 1000000 / AREA_B[country]
...
def main():
    ...
    scatters = {country: ax.scatter([], [], s=[], label=COUNTRY_NAMES_B.get(country, country)) for country in countries}
